# Домашнее задание к занятию 3 «Использование Ansible» - Тимохин Максим
  ...
  tasks:
    ...
    - name: Make nginx config
      ...
      ansible.builtin.template:
        src: /home/timohin/lesson/devops-netology/08-ansible-03-yandex/templates/default.j2
...
```
timohin@ubuntu# ansible-lint site.yml
...
```
```
root@ubuntu# ssh user@158.160.12.243
...
9. Подготовьте README.md-файл по своему playbook. В нём должно быть описано: что делает playbook, какие у него есть параметры и теги.
 ...
 https://github.com/MrAgrippa/06-db/blob/main/08-ansible-03-yandex.md

10. Готовый playbook выложите в свой репозиторий, поставьте тег 08-ansible-03-yandex на фиксирующий коммит, в ответ предоставьте ссылку на него.

https://github.com/MrAgrippa/06-db/blob/main/img/08-03/site.yml
