# Домашнее задание к занятию 9 «Процессы CI/CD» - Тимохин Максим
...
ansible-playbook  
```
root@ubuntu# sudo ansible-playbook -i inventory/cicd/hosts.yml site.yml
...
```
root@ubuntu# sonar-scanner --version
INFO: Scanner configuration file: /home/timohin/09-ci-03-cicd/infrastructure/sonar-scanner-4.8.0.2856-linux/conf/sonar-scanner.properties
INFO: Project root configuration file: NONE
INFO: SonarScanner 4.8.0.2856
INFO: Java 11.0.17 Eclipse Adoptium (64-bit)
INFO: Linux 6.0.0-ubuntu-amd64 amd64
```
5. Запустите анализатор против кода из директории example с дополнительным ключом -Dsonar.coverage.exclusions=fail.py.

```
root@ubuntu# sonar-scanner \
  -Dsonar.projectKey=netology \
  -Dsonar.sources=. \
  -Dsonar.host.url=http://158.160.3.34:9000 \
...
INFO: Base dir: /home/timohin/09-ci-03-cicd/example
INFO: Working dir: /home/timohin/09-ci-03-cicd/example/.scannerwork
...
INFO: ANALYSIS SUCCESSFUL, you can browse http://158.160.3.34:9000/dashboard?id=netology
INFO: Note that you will be able to access the updated dashboard once the server has processed the submitted analysis report
INFO: More about the report processing at http://158.160.3.34:9000/api/ce/task?id=AYlKsuTLAoU1PTOFhWfR
...
Maven home: /home/timohin/09-ci-03-cicd/infrastructure/apache-maven-3.9.3
Java version: 17.0.6, vendor: Debian, runtime: /usr/lib/jvm/java-17-openjdk-amd64
Default locale: en_US, platform encoding: UTF-8
OS name: "linux", version: "6.0.0-ubuntu-amd64", arch: "amd64", family: "unix"
```
...
[INFO] Building jar: /home/timohin/09-ci-03-cicd/infrastructure/apache-maven-3.9.3/simple-app-1.0-SNAPSHOT.jar
[INFO] ------------------------------------------------------------------------
[INFO] BUILD SUCCESS
[INFO] ------------------------------------------------------------------------
...
```
root@ubuntu# ls ~/.m2/repository/netology/java/8_282/
total 16
